<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scientist_edit.aspx.cs" Inherits="Project_Aris.scientist_edit" %>
                ...
                <form action="#" runat="server">
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <asp:TextBox ID="txtFname" runat="server" CssClass="input-field" placeholder="Enter your name" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                            <asp:Label ID="lblLname" runat="server" AssociatedControlID="txtLname">Last Name:</asp:Label>
                            <asp:TextBox ID="txtLname" runat="server" CssClass="input-field" placeholder="Enter your last name" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            <asp:Label ID="lblDivID" runat="server" AssociatedControlID="txtDivID">DivID:</asp:Label>
                            <asp:TextBox ID="txtDivID" runat="server" CssClass="input-field" placeholder="Enter the DivID" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                            <asp:Label ID="lblDiscipline" runat="server" AssociatedControlID="txtDiscipline">Discipline:</asp:Label>
                            <asp:TextBox ID="txtDiscipline" runat="server" CssClass="input-field" placeholder="Enter the discipline" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                            <asp:Label ID="lblDesigID" runat="server" AssociatedControlID="txtDesigID">DesigID:</asp:Label>
                            <asp:TextBox ID="txtDesigID" runat="server" CssClass="input-field" placeholder="Enter the DesigID" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                            <asp:Label ID="lblDoB" runat="server" AssociatedControlID="txtDoB">Date of Birth:</asp:Label>
                            <asp:TextBox ID="txtDoB" runat="server" CssClass="input-field" TextMode="Date" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                            <asp:Label ID="lblDoJ" runat="server" AssociatedControlID="txtDoJ">Date of Joining:</asp:Label>
                            <asp:TextBox ID="txtDoJ" runat="server" CssClass="input-field" TextMode="Date" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                            <asp:Label ID="lblEmailICAR" runat="server" AssociatedControlID="txtEmailICAR">EmailICAR:</asp:Label>
                            <asp:TextBox ID="txtEmailICAR" runat="server" CssClass="input-field" TextMode="Email" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <asp:TextBox ID="txtMob1" runat="server" CssClass="input-field" ></asp:TextBox>
                        </div>
                        <div class="input-box">
                    ...
                    <div class="button">
                        <asp:Button  CssClass="register-btn" ID="btnUpdate" runat="server" Text="Update" OnClick="btnUpdate_Click" />
                    </div>
                </form>
            </div>
        </asp:Panel>
